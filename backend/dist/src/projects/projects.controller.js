...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all projects accessible to the current user' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Projects list returned successfully' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get project by ID with towers, members and schedule summary' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Project returned successfully' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Access denied to this project' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update project (ADMIN or ENGINEER role required)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Project updated successfully' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Insufficient project role' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Project not found' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete project (ADMIN role required)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Add or update a member in the project (ADMIN role required)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Member added or updated successfully' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Insufficient project role' }),

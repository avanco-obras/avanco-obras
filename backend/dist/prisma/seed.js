...
async function main() {
    ...
    const activityTypesData = [
        { name: 'Alvenaria', measurementMethod: client_1.MeasurementMethod.METRIC, unit: 'm²', defaultQuantity: 80.00, weight: 1.5, order: 1 },
        { name: 'Reboco', measurementMethod: client_1.MeasurementMethod.METRIC, unit: 'm²', defaultQuantity: 80.00, weight: 1.2, order: 2 },
        { name: 'Contrapiso', measurementMethod: client_1.MeasurementMethod.METRIC, unit: 'm²', defaultQuantity: 60.00, weight: 1.0, order: 3 },
        { name: 'Instalação Hidráulica', measurementMethod: client_1.MeasurementMethod.PERCENT, unit: '%', defaultQuantity: 100.00, weight: 1.3, order: 4 },
        { name: 'Instalação Elétrica', measurementMethod: client_1.MeasurementMethod.PERCENT, unit: '%', defaultQuantity: 100.00, weight: 1.3, order: 5 },
        { name: 'Revestimento de Piso', measurementMethod: client_1.MeasurementMethod.METRIC, unit: 'm²', defaultQuantity: 55.00, weight: 1.1, order: 6 },
        { name: 'Pintura', measurementMethod: client_1.MeasurementMethod.PERCENT, unit: '%', defaultQuantity: 100.00, weight: 0.9, order: 7 },
        { name: 'Gesso/Drywall', measurementMethod: client_1.MeasurementMethod.METRIC, unit: 'm²', defaultQuantity: 70.00, weight: 1.0, order: 8 },
    ];
    const activityTypes = {};
        ...
        for (const floor of tower.floors) {
            ...
            for (let aIdx = 0; aIdx < activityTypeIds.length; aIdx++) {
                ...
                for (const unit of floor.units) {
                    const unitVariation = (unit.order - 1.5) * 2;
    ...
    await prisma.weeklyTask.createMany({
        data: [
            ...
            },
            {
                ...
                status: client_1.TaskStatus.NOT_COMPLETED,
    ...
    await prisma.weeklyTask.createMany({
        data: [
            ...
            },
            {
                ...
                location: 'Torre A - 3º Andar',
                status: client_1.TaskStatus.PARTIALLY,
        ...
        data: [
            {
                ...
                status: client_1.RestrictionStatus.RELEASED,
            ...
            },
            {
                ...
                status: client_1.RestrictionStatus.IN_ANALYSIS,
                resolvedAt: null,
            },
            {
                weeklyPlanId: week18.id,
                ...
                status: client_1.RestrictionStatus.PENDING,
                resolvedAt: null,
            },
        ],
    });
